...
bitmapFileHelper(`${__dirname}/../assets/palette-bitmap.bmp`, function(err, data) {
  ...
  function newFile(fileName) {
    console.log('expected:', bmp.all);
    console.log('header:', bmp.headerAll);
    let newBuffer = Buffer.from((bmp.headerAll + bmp.colorArr + bmp.pixelArr), 'hex');
    console.log('output:', newBuffer);
